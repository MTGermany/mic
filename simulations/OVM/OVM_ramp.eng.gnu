...
##################################
set out "./OVM_ramp_v3d.eng.eps"
print "plotting ./OVM_ramp_v3d.eng.eps"
##################################
...
splot "OVM_ramp.dat" u ($2*60-tshift):($1-xramp2):4 w l ls 99
...
##################################
set out "./OVM_ramp_fund.eng.eps"
print "plotting ./OVM_ramp_fund.eng.eps"
##################################
...
plot\
 "OVM_ramp.x8000_det" u (rhofun($2, $3)):(Qfun($2)) t "-7 km" w p ls 6,\
 "OVM_ramp.x10000_det" u (rhofun($2, $3)):(Qfun($2)) t "-5 km" w p ls 4,\
 "OVM_ramp.x12000_det" u (rhofun($2, $3)):(Qfun($2)) t "-3 km" w p ls 2,\
 "OVM_ramp.x14000_det" u (rhofun($2, $3)):(Qfun($2)) t "-1 km" w p ls 1

##################################
set out "./OVM_ramp_fundDouble.eng.eps"
print "plotting ./OVM_ramp_fundDouble.eng.eps"
##################################
...
##################################
set out "./OVM_ramp_fundHarm.eng.eps"
print "plotting ./OVM_ramp_fundHarm.eng.eps"
##################################
set xrange [rhomin:rhomaxReal]

plot\
 "OVM_ramp.x8000_det" u (rhoharmFun($5, $4)):(QharmFun($5)) t "-7 km" w p ls 6,\
 "OVM_ramp.x10000_det" u (rhoharmFun($5, $4)):(QharmFun($5)) t "-5 km" w p ls 4,\
 "OVM_ramp.x12000_det" u (rhoharmFun($5, $4)):(QharmFun($5)) t "-3 km" w p ls 2,\
 "OVM_ramp.x14000_det" u (rhoharmFun($5, $4)):(QharmFun($5)) t "-1 km" w p ls 1


##################################
set out "./OVM_ramp_fundHarm1.eng.eps"
print "plotting ./OVM_ramp_fundHarm1.eng.eps"
##################################
plot\
...
print "plotting ./OVM_ramp_fundvHarm1.eng.eps"
##################################
plot\
...
set out "./OVM_ramp_fund_Q_vs_QdivV.eng.eps"
print "plotting ./OVM_ramp_fund_Q_vs_QdivV.eng.eps"
##################################
plot\
...
set out "./OVM_ramp_fund_Q_vs_QdivVH.eng.eps"
print "plotting ./OVM_ramp_fund_Q_vs_QdivVH.eng.eps"
##################################
plot\
...
print "plotting ./OVM_ramp_fund_QH_vs_QHdivVH.eng.eps"
##################################
plot\
...
print "plotting ./OVM_ramp_fund_QH_vs_QHdivV.eng.eps"
##################################
plot\
...
################################## 
set out "./OVM_ramp_fund_Q_vs_QHdivVH.eng.eps"
print "plotting ./OVM_ramp_fund_Q_vs_QHdivVH.eng.eps"
##################################
plot\
...
##################################
set out "./OVM_ramp_fundTrue.eng.eps"
print "plotting ./OVM_ramp_fundTrue.eng.eps"
##################################
set xlabel "Density {/Symbol r} (1/km)"
...
plot\
 "OVM_ramp.x8000_macro" u 3:5 t "-7 km" w p ls 6,\
...
print "plotting ./OVM_ramp_QV.eng.eps"
##################################
...
set yrange [0:Vmax]
plot\
 "OVM_ramp.x8000_det" u (Qfun($2)):($3) t "-7 km" w p ls 6,\
 "OVM_ramp.x10000_det" u (Qfun($2)):($3) t "-5 km" w p ls 4,\
 "OVM_ramp.x12000_det" u (Qfun($2)):($3) t "-3 km" w p ls 2,\
 "OVM_ramp.x14000_det" u (Qfun($2)):($3) t "-1 km" w p ls 1

##################################
set out "./OVM_ramp_QVharm.eng.eps"
print "plotting ./OVM_ramp_QVharm.eng.eps"
##################################
plot\
 "OVM_ramp.x8000_det" u (QharmFun($5)):(vharmFun($4)) t "-7 km" w p ls 6,\
 "OVM_ramp.x10000_det" u (QharmFun($5)):(vharmFun($4)) t "-5 km" w p ls 4,\
 "OVM_ramp.x12000_det" u (QharmFun($5)):(vharmFun($4)) t "-3 km" w p ls 2,\
 "OVM_ramp.x14000_det" u (QharmFun($5)):(vharmFun($4)) t "-1 km" w p ls 1

##################################
set out "./OVM_ramp_QVTrue.eng.eps"
print "plotting ./OVM_ramp_QVTrue.eng.eps"
##################################
plot\
 "OVM_ramp.x8000_macro" u 5:4 t "-7 km" w p ls 6,\
...
##################################
set out "./OVM_ramp_rhoV.eng.eps"
print "plotting ./OVM_ramp_rhoV.eng.eps"
##################################
...
set yrange [0:Vmax]
plot\
 "OVM_ramp.x8000_det" u (rhofun($2, $3)):($3) t "-7 km" w p ls 6,\
 "OVM_ramp.x10000_det" u (rhofun($2, $3)):($3) t "-5 km" w p ls 4,\
 "OVM_ramp.x12000_det" u (rhofun($2, $3)):($3) t "-3 km" w p ls 2,\
 "OVM_ramp.x14000_det" u (rhofun($2, $3)):($3) t "-1 km" w p ls 1

##################################
set out "./OVM_ramp_rhoVDouble.eng.eps"
print "plotting ./OVM_ramp_rhoVDouble.eng.eps"
##################################
set xrange [0:rhomaxReal]
plot\
 "OVM_ramp.x8000_det" u (rhofun($2, $3)):($3) t "-7 km" w p ls 6,\
...
##################################
set out "./OVM_ramp_rhoVharm.eng.eps"
print "plotting ./OVM_ramp_rhoVharm.eng.eps"
##################################
set xrange [0:rhomaxReal]
plot\
 "OVM_ramp.x8000_det" u (rhoharmFun($5,$4)):(vharmFun($4)) t "-7 km" w p ls 6,\
 "OVM_ramp.x10000_det" u (rhoharmFun($5,$4)):(vharmFun($4)) t "-5 km" w p ls 4,\
 "OVM_ramp.x12000_det" u (rhoharmFun($5,$4)):(vharmFun($4)) t "-3 km" w p ls 2,\
 "OVM_ramp.x14000_det" u (rhoharmFun($5,$4)):(vharmFun($4)) t "-1 km" w p ls 1

##################################
set out "./OVM_ramp_rhoVTrue.eng.eps"
print "plotting ./OVM_ramp_rhoVTrue.eng.eps"
##################################
plot\
 "OVM_ramp.x8000_macro" u 3:4 t "-7 km" w p ls 6,\
...
###############################################
set out "./OVM_ramp_v.eng.eps"
print "plotting ./OVM_ramp_v.eng.eps"
###############################################
...
splot[t=tmin:tmax] \
 "OVM_ramp.x16000_det" u  ($1-tshift): (vFun($1, xD0, $3)-0.2):($3) w l ls 22,\
 "OVM_ramp.x15000_det" u  ($1-tshift): (vFun($1, xD1, $3)):($3) w l ls 22,\
 "OVM_ramp.x14000_det" u  ($1-tshift): (vFun($1, xD2, $3)):($3) w l ls 22,\
 "OVM_ramp.x13000_det" u  ($1-tshift): (vFun($1, xD3, $3)):($3) w l ls 22,\
 "OVM_ramp.x12000_det" u  ($1-tshift): (vFun($1, xD4, $3)):($3) w l ls 22,\
 "OVM_ramp.x11000_det" u  ($1-tshift): (vFun($1, xD5, $3)):($3) w l ls 22,\
 "OVM_ramp.x10000_det"   u  ($1-tshift): (vFun($1, xD6, $3)):($3) w l ls 22,\
  t, xD0 ,-1 w l ls 99,\
  t, xD1 ,-1 w l ls 11,\
  t, xD2 ,0 w l ls 11,\
  t, xD3 ,0 w l ls 11,\
...
###############################################
set out "./OVM_ramp_Q.eng.eps"
print "plotting ./OVM_ramp_Q.eng.eps"
###############################################
...
plot[t=tmin:tmax] \
 "OVM_ramp.x16000_det" u  ($1-tshift): (QFun($1, xD0, $3)-0.2) w l ls 12,  t, xD0 w l ls 1,\
 "OVM_ramp.x15000_det" u  ($1-tshift): (QFun($1, xD1, $3)) w l ls 12,  t, xD1 w l ls 1,\
 "OVM_ramp.x14000_det" u  ($1-tshift): (QFun($1, xD2, $3)) w l ls 12,  t, xD2 w l ls 1,\
 "OVM_ramp.x13000_det" u  ($1-tshift): (QFun($1, xD3, $3)) w l ls 12,  t, xD3 w l ls 1,\
 "OVM_ramp.x12000_det" u  ($1-tshift): (QFun($1, xD4, $3)) w l ls 12,  t, xD4 w l ls 1,\
 "OVM_ramp.x11000_det" u  ($1-tshift): (QFun($1, xD5, $3)) w l ls 12,  t, xD5 w l ls 1,\
 "OVM_ramp.x10000_det"   u  ($1-tshift): (QFun($1, xD6, $3)) w l ls 12,  t, xD6 w l ls 1
